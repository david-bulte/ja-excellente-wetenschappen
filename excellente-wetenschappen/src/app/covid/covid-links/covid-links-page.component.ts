...
import { CovidLinkService } from './covid-link.service';

@Component({
  selector: 'app-covid-links-page',
  template: `
...
export class CovidLinksPageComponent implements OnInit {

  rootConfigs$ = this.service.getConfigs();

  constructor(private service: CovidLinkService) {
  }
