  ...
  template: `
    <div class="d-flex flex-column align-items-center w-100 position-relative">
      ...
      <div class="download d-none d-md-block">
        <div class="animate__animated animate__pulse text-primary">
          <a href="assets/covid/covid-factsheet.pdf" target="_blank">
            <fa-icon [icon]="'cloud-download-alt'" [size]="'sm'"></fa-icon>
            Download de factsheet
          </a>
          ( <a href="assets/covid/covid-factsheet.pdf" target="_blank">nl</a> | <a href="assets/covid/covid-factsheet-en.pdf" target="_blank">en</a> )
        </div>
      </div>
      ...
      <div class="text-container mb-3 mt-3">
        ...
        <p>
          <a href="https://www.nature.com/articles/s41562-020-0921-y" target="_blank">Myers et al. (2020)</a> vroegen
          4.535 principal investigators of PI’s (d.w.z. professoren en andere
        ...
        <p>
          <a href="https://www.nature.com/articles/s41562-020-0921-y" target="_blank">Ook de internationale studie van
            Myers et al. </a>stelde vast dat het al dan niet hebben van zorgtaken een sterke
        ...
        <p>
          <a href="https://today.vub.be/nl/artikel/eerste-bevindingen-vub-tijdsbestedingsonderzoek-in-tijden-van-corona"
             target="_blank">Het dagboekonderzoek onder de Vlaamse bevolking</a> wees uit dat vrouwen gemiddeld 13u per
          week meer tijd besteedden aan
          zorgtaken tijdens de lockdown dan voordien. Mannen rapporteren daarentegen gemiddeld méér vrije tijd. Ook de
          mate waarin corona-ouderschapsverlof werd opgenomen in België, verschilde sterk tussen mannen en vrouwen. <a
          href="https://www.demorgen.be/nieuws/corona-duwt-vrouwen-weer-naar-de-haard" target="_blank">De
          Rijksdienst voor Arbeidsvoorziening </a>telde bijna 265.000 ouders die corona-ouderschapsverlof opnamen en
          stelde
        ...
        <p>
          ...
          academici in Vlaanderen. Maar <a href="https://www.nature.com/articles/s41562-020-0921-y" target="_blank">de
          internationale studie van Myers et al. </a>laat zien dat de afname van de
        ...
        <p>
          ...
          projectoproepen. Zo stelden <a href="https://go.nature.com/2XhxqxR" target="_blank">3 databases met
          registered-reports (n = 14.000)</a> vast dat er een significante
          daling was van het aantal onderzoeksprojecten dat vrouwelijke PI’s registreerden in maart en april 2020 dan in
          dezelfde periode in 2019.10 Daarbovenop blijken <a
          href="https://voxeu.org/article/who-doing-new-research-time-covid-19-not-female-economists" target="_blank">vrouwen
          in verschillende wetenschapsgebieden minder betrokken
